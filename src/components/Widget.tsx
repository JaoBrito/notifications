...
export function Widget() {
  return (
    <div className="w-[448px] rounded overflow-hidden">
      ...
      {/* Recent Section*/}
      <div>
        <div className="bg-zinc-300 font-medium dark:bg-zinc-950 px-5 py-2 text-small text-zinc-500 dark:text-zinc-400">Recentes</div>
      ...
      {/* Old Section*/}
      <div>
        <div className="bg-zinc-300 font-medium dark:bg-zinc-950 px-5 py-2 text-small text-zinc-500 dark:text-zinc-400">Antigas</div>
